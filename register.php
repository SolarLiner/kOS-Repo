<html lang="en">
	...
	<div class="container">
		<div class="col-sm-12 col-lg-8 col-lg-offset-2">
			<form class="form-horizontal" action="register_confirm.php" method="post" enctype="multipart/form-data">
				<fieldset>
				...
				<div class="form-group">
				  ...
				  <div class="col-md-4">                     
				    <textarea class="form-control" id="biography" name="biography">Tell more about you. Please. :)</textarea>
				  </div>
				</div>
